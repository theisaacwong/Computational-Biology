...
public class Launcher {
	...
	public static void main(String[] args) {
		...
		ForwardPopGenSimulation intialFPGS = new ForwardPopGenSimulation(omega, tmax, popsize, cnumber, gamma, pmax, minGam, maxGam, seed);
		...
		{ 
			Thread object = new Thread(new ForwardPopGenSimulation(initialZTrans, 
					initialDummyDist, 
					omega,
					tmax, 
					popsize, 
