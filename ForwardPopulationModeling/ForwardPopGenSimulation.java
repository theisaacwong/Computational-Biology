...
public class ForwardPopGenSimulation implements Runnable{
     ...
     */
    @Deprecated
	public ForwardPopGenSimulation() {
		this.omega = 10000;
		this.tmax = 100;
		this.popsize = 1000;
		this.cnumber = 100;
     ...
     */
    @Deprecated
	public ForwardPopGenSimulation(double[] ztrans, int[] dummy) {
		this.omega = 10000;
		this.tmax = 100;
		this.popsize = 1000;
		this.cnumber = 100;
	...
	public ForwardPopGenSimulation(double[] ztrans, int[] dummy, int omega, int tmax, int popsize, int cnumber, double gamma, int pmax, double minGam, double maxGam, long gam_test_max, long maxiters) {
		this.omega = omega;
		this.tmax = tmax;
	...
	public ForwardPopGenSimulation(int omega, int tmax, int popsize, int cnumber, double gamma, int pmax, double minGam, double maxGam, long seed) {
		this.omega = omega;
		this.tmax = tmax;
		this.popsize = popsize;
		this.cnumber = cnumber;
